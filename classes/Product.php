        ...
        public function displayProducts(){
            ...
            if($result = $this->conn->query($sql)){
                while($item = $result->fetch_assoc()){
                    ...
                    /*
                        $item
                        ['id' => 1, 'product_name' => 'Milk', 'price' => 10, 'quantity' => 10]
                    */

                    /* 
                        Then when you do $items[] = $item;, you're adding that associative array to $items, which creates a indexed array of associative arrays.

                        $items
                        [
                            0 => ['id' => 1, 'product_name' => 'Apple', 'price' => 3.00, 'quantity' => 2],
                            1 => ['id' => 2, 'product_name' => 'Milk', 'price' => 10.00, 'quantity' => 10],
                            ...
                        ]
                    */
                }
